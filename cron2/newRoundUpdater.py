...
for roundID in cur.fetchall():
	...
	os.system('python /opt/lampp/htdocs/HE/python/npc_generator.py')
	...
	os.system('python /opt/lampp/htdocs/HE/cron2/updateRanking.py')
	os.system('python /opt/lampp/htdocs/HE/python/rank_generator.py')
