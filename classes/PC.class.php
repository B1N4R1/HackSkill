...
<?php
    ...
    public function listRunningSoftwares() {
        ...
        if ($rows != '0') {
            ...
            ?>
                <div class="span9">
                    <?php echo _('Ops! There are no softwares running in your system. <br/>Go to the <a href="software">software</a> page to run them.'); ?>
                </div>
            <?php
        }
        ...
        ?>
                ...
                <div class="span3 center">
                    ...
                    <div class="hd-usage">
                        <div class="percentage easyPieChart" data-percent="<?php echo ceil(0); //$usedRamPerc ?>">
                            <strong><span></span>%</strong>
                        </div>
                        <div class="hd-usage-text"><?php echo _("RAM usage"); ?></div>
                        <span class="small"><font color="green"><?php echo round(0,2); //$usedRam ?> MB</font> / <font color="red"><?php echo round($ramInfo['RAM'], 2); ?> MB</font></span>
                    </div>
