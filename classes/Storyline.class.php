...
<?php
    ...
    public function tutorial_start(){
        ...
        $this->session->newQuery();
        $sqlQuery = "INSERT INTO software (userID, softName, softVersion, softSize, softRam, softType, softLastEdit, softHidden, softHiddenWith, isNPC, originalFrom)
            VALUES (?, 'cracker', '10', '28', '9', '1', NOW(), '0', '0', '0', '0')";
